...
function Money(amount, currency) {
    ...
    if (!isPlainObject(currency)) {
        console.log('currency', currency, 'currencies', currencies);
...
Money.addCurrency = function(currency) {
    console.log('currencies before add ', currencies);
    for (var currencyCode in currency) { 
        console.log('currencies in loop');
        currencies[currencyCode] = currency[currencyCode]; 
    }
    console.log('currencies after add ', currencies);
};
